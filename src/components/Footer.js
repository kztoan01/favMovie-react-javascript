        ...
        <div className="container">
          <div className="row">
            <div className="col l6 s12">
              ...
              <p className="grey-text text-lighten-4">This my my website using ReactJS to show my favorite movies.</p>
            </div>
            <div className="col l4 offset-l2 s12">
              ...
              <ul>
                ...
                <li><Link  to="/news" className="grey-text text-lighten-3" >News</Link></li>
